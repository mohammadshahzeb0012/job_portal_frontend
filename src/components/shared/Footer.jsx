...
const Footer = () => {
  return (
    <footer className="bg-[#F7F6E0] border-t border-t-gray-200 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Dreamo<span className='text-[#F83002]'>Jobs</span></h2>
            <p className="footer-reservd-text">© 2024 DreamoJobs. All rights reserved. All content and design related to DreamoJobs, including job listings, user interface elements, descriptions, and other materials, are the property of DreamoJobs. Unauthorized copying, reproduction, or distribution of this content is prohibited..</p>
          </div>
